...
<Heading size="H7"ml="5px" d={{tb:"none"}}>Assets</Heading>
  <Heading size="H7"mr="25px" d={{base:"none", tb:"inline"}}>24h</Heading>
  <Heading size="H7" mr="7px" d={{base:"none", tb:"inline"}}>7d</Heading>
  <Heading size="H7" mr="11px"d={{tb:"none"}}>Last 7d</Heading>
